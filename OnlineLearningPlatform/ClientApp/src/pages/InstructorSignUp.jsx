...
export default function InstructorSignUp() {
    ...
    return (
        <div style={{
            background: 'linear-gradient(45deg, rgb(255, 187, 92)  0%, rgb(255, 155, 80) 40%,  rgb(198, 61, 47) 100%)',
            height: '80vh'
        }}>
                        ...
                        <Grid container justifyContent="flex-end">
                            <Grid item>
                                <Link href="/signup" variant="body2">
                                    <label className="linkLabels">Create a student account instead</label>
                                </Link>
                            </Grid>
                        </Grid>
                        <Grid container justifyContent="flex-end">
